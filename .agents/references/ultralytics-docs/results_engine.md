...
[Classes](https://docs.ultralytics.com/reference/engine/results/#classes)[Properties](https://docs.ultralytics.com/reference/engine/results/#properties)[Methods](https://docs.ultralytics.com/reference/engine/results/#methods)
...
| --- | --- | --- | --- |
| `data` | `torch.Tensor \\| np.ndarray` | Prediction data such as bounding boxes, masks, or keypoints. | _required_ |
| `orig_shape` | `tuple[int, int]` | Original shape of the image in (height, width) format. | _required_ |
...
| Name | Description |
| --- | --- |
| [`shape`](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.BaseTensor.shape) | Return the shape of the underlying data tensor. |
| [`__getitem__`](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.BaseTensor.__getitem__) | Return a new BaseTensor instance containing the specified indexed elements of the data tensor. |
| [`__len__`](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.BaseTensor.__len__) | Return the length of the underlying data tensor. |
| [`cpu`](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.BaseTensor.cpu) | Return a copy of the tensor stored in CPU memory. |
| [`cuda`](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.BaseTensor.cuda) | Move the tensor to GPU memory. |
| [`numpy`](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.BaseTensor.numpy) | Return a copy of this object with its data converted to a NumPy array. |
| [`to`](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.BaseTensor.to) | Return a copy of the tensor with the specified device and dtype. |
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `idx` | `int \\| list[int] \\| torch.Tensor` | Index or indices to select from the data tensor. | _required_ |
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `*args` | `Any` | Variable length argument list to be passed to torch.Tensor.to(). | _required_ |
| `**kwargs` | `Any` | Arbitrary keyword arguments to be passed to torch.Tensor.to(). | _required_ |
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `orig_img` | `np.ndarray` | The original image as a numpy array. | _required_ |
| `path` | `str` | The path to the image file. | _required_ |
| `names` | `dict` | A dictionary of class names. | _required_ |
...
| Name | Description |
| --- | --- |
| [`__getitem__`](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.Results.__getitem__) | Return a Results object for a specific index of inference results. |
| [`__len__`](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.Results.__len__) | Return the number of detections in the Results object. |
| [`_apply`](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.Results._apply) | Apply a function to all non-empty attributes and return a new Results object with modified attributes. |
| [`cpu`](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.Results.cpu) | Return a copy of the Results object with all its tensors moved to CPU memory. |
| [`cuda`](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.Results.cuda) | Move all tensors in the Results object to GPU memory. |
| [`new`](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.Results.new) | Create a new Results object with the same image, path, names, and speed attributes. |
| [`numpy`](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.Results.numpy) | Convert all tensors in the Results object to numpy arrays. |
| [`plot`](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.Results.plot) | Plot detection results on an input BGR image. |
| [`save`](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.Results.save) | Save annotated inference results image to file. |
| [`save_crop`](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.Results.save_crop) | Save cropped detection images to specified directory. |
| [`save_txt`](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.Results.save_txt) | Save detection results to a text file. |
| [`show`](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.Results.show) | Display the image with annotated inference results. |
| [`summary`](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.Results.summary) | Convert inference results to a summarized dictionary with optional normalization for box coordinates. |
| [`to`](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.Results.to) | Move all tensors in the Results object to the specified device and dtype. |
| [`update`](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.Results.update) | Update the Results object with new detection data. |
| [`verbose`](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.Results.verbose) | Return a log string for each task in the results, detailing detection and classification outcomes. |
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `idx` | `int \\| slice` | Index or slice to retrieve from the Results object. | _required_ |
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `fn` | `str` | The name of the function to apply. | _required_ |
| `*args` | `Any` | Variable length argument list to pass to the function. | _required_ |
| `**kwargs` | `Any` | Arbitrary keyword arguments to pass to the function. | _required_ |
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `filename` | `str \\| None` | The filename to save the annotated image. If None, a default filename is generated based on the original image path. | `None` |
| `*args` | `Any` | Variable length argument list to be passed to the `plot` method. | _required_ |
| `**kwargs` | `Any` | Arbitrary keyword arguments to be passed to the `plot` method. | _required_ |
...
This method saves cropped images of detected objects to a specified directory. Each crop is saved in a subdirectory named after the object's class, with the filename based on the input file\_name.

**Args**

| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `save_dir` | `str \\| Path` | Directory path where cropped images will be saved. | _required_ |
...
-   Crops are saved as 'save\_dir/class\_name/file\_name.jpg'.
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `txt_file` | `str \\| Path` | Path to the output text file. | _required_ |
...
-   If save\_conf is False, the confidence scores will be excluded from the output.
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `boxes` | `torch.Tensor \\| None` | A tensor of shape (N, 6) containing bounding box coordinates and confidence scores. The format is (x1, y1, x2, y2, conf, class). | `None` |
| `masks` | `torch.Tensor \\| None` | A tensor of shape (N, H, W) containing segmentation masks. | `None` |
| `probs` | `torch.Tensor \\| None` | A tensor of shape (num\\_classes,) containing class probabilities. | `None` |
...
| Type | Description |
| --- | --- |
| `torch.Tensor \\| np.ndarray` | Boxes in \\[x\\_center, y\\_center, width, height\\] format, where x\\_center, y\\_center |
...
This property calculates and returns the normalized bounding box coordinates in the format \[x\_center, y\_center, width, height\], where all values are relative to the original image dimensions.
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `masks` | `torch.Tensor \\| np.ndarray` | Detection masks with shape (num\\_masks, height, width). | _required_ |
| `orig_shape` | `tuple[int, int]` | The original image shape as (height, width). Used for normalization. | _required_ |
...
| Name | Description |
| --- | --- |
| [`xyn`](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.Masks.xyn) | Return normalized xy-coordinates of the segmentation masks. |
| [`xy`](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.Masks.xy) | Return the \\[x, y\\] pixel coordinates for each segment in the mask tensor. |
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `keypoints` | `torch.Tensor \\| np.ndarray` | A tensor or array containing keypoint data. Shape can be either: \\- (num\\_objects, num\\_keypoints, 2) for x, y coordinates only \\- (num\\_objects, num\\_keypoints, 3) for x, y coordinates and confidence scores | _required_ |
| `orig_shape` | `tuple[int, int]` | The original image dimensions (height, width). | _required_ |
...
| `xyn` | `torch.Tensor` | Normalized keypoint coordinates in \\[x, y\\] format, relative to orig\\_shape. |
...
| Name | Description |
| --- | --- |
| [`xy`](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.Keypoints.xy) | Return x, y coordinates of keypoints. |
| [`xyn`](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.Keypoints.xyn) | Return normalized coordinates (x, y) of keypoints relative to the original image size. |
| [`conf`](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.Keypoints.conf) | Return confidence values for each keypoint. |
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `probs` | `torch.Tensor \\| np.ndarray` | A 1D tensor or array of classification probabilities. | _required_ |
| `orig_shape` | `tuple[int, int] \\| None` | The original image shape as (height, width). Not used in this class but kept for consistency with other result classes. | `None` |
...
| Name | Description |
| --- | --- |
| [`top1`](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.Probs.top1) | Return the index of the class with the highest probability. |
| [`top5`](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.Probs.top5) | Return the indices of the top 5 class probabilities. |
| [`top1conf`](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.Probs.top1conf) | Return the confidence score of the highest probability class. |
| [`top5conf`](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.Probs.top5conf) | Return confidence scores for the top 5 classification predictions. |
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `boxes` | `torch.Tensor \\| np.ndarray` | A tensor or numpy array containing the detection boxes, with shape (num\\_boxes, 7) or (num\\_boxes, 8). The last two columns contain confidence and class values. If present, the third last column contains track IDs, and the fifth column contains rotation. | _required_ |
| `orig_shape` | `tuple[int, int]` | Original image size, in the format (height, width). | _required_ |
...
| `is_track` | `bool` | Indicates whether tracking IDs are included in the box data. |
| `xywhr` | `torch.Tensor \\| np.ndarray` | Boxes in \\[x\\_center, y\\_center, width, height, rotation\\] format. |
| `conf` | `torch.Tensor \\| np.ndarray` | Confidence scores for each box. |
| `cls` | `torch.Tensor \\| np.ndarray` | Class labels for each box. |
...
| `xyxyxyxyn` | `torch.Tensor \\| np.ndarray` | Normalized 8-point coordinates relative to orig\\_shape. |
...
| Name | Description |
| --- | --- |
| [`xywhr`](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.OBB.xywhr) | Return boxes in \\[x\\_center, y\\_center, width, height, rotation\\] format. |
| [`conf`](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.OBB.conf) | Return the confidence scores for Oriented Bounding Boxes (OBBs). |
| [`cls`](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.OBB.cls) | Return the class values of the oriented bounding boxes. |
| [`id`](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.OBB.id) | Return the tracking IDs of the oriented bounding boxes (if available). |
| [`xyxyxyxy`](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.OBB.xyxyxyxy) | Convert OBB format to 8-point (xyxyxyxy) coordinate format for rotated bounding boxes. |
| [`xyxyxyxyn`](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.OBB.xyxyxyxyn) | Convert rotated bounding boxes to normalized xyxyxyxy format. |
| [`xyxy`](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.OBB.xyxy) | Convert oriented bounding boxes (OBB) to axis-aligned bounding boxes in xyxy format. |
...
Source code in `ultralytics/engine/results.py`[View on GitHub](https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L1333-L1533)
...
Return boxes in \[x\_center, y\_center, width, height, rotation\] format.
