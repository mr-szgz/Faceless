...
retrieved: 2026-04-15T19:49:43.098899+00:00
final_url: https://docs.ultralytics.com/reference/engine/results/
content_type: text/html
-->

# Reference for ultralytics/engine/results.py - Ultralytics YOLO Docs

[Skip to content](https://docs.ultralytics.com/reference/engine/results/#reference-for-ultralyticsengineresultspy)

[https://github.com/ultralytics/ultralytics/tree/main/docs/en/reference/engine/results.md](https://github.com/ultralytics/ultralytics/tree/main/docs/en/reference/engine/results.md)
...
- ``[BaseTensor](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.BaseTensor)

- ``[Results](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.Results)

- ``[Boxes](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.Boxes)

- ``[Masks](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.Masks)

- ``[Keypoints](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.Keypoints)

- ``[Probs](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.Probs)

- ``[OBB](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.OBB)

- ``[BaseTensor.shape](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.BaseTensor.shape)

- ``[Boxes.xyxy](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.Boxes.xyxy)

- ``[Boxes.conf](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.Boxes.conf)

- ``[Boxes.cls](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.Boxes.cls)

- ``[Boxes.id](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.Boxes.id)

- ``[Boxes.xywh](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.Boxes.xywh)

- ``[Boxes.xyxyn](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.Boxes.xyxyn)

- ``[Boxes.xywhn](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.Boxes.xywhn)

- ``[Masks.xyn](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.Masks.xyn)

- ``[Masks.xy](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.Masks.xy)

- ``[Keypoints.xy](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.Keypoints.xy)

- ``[Keypoints.xyn](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.Keypoints.xyn)

- ``[Keypoints.conf](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.Keypoints.conf)

- ``[Probs.top1](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.Probs.top1)

- ``[Probs.top5](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.Probs.top5)

- ``[Probs.top1conf](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.Probs.top1conf)

- ``[Probs.top5conf](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.Probs.top5conf)

- ``[OBB.xywhr](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.OBB.xywhr)

- ``[OBB.conf](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.OBB.conf)

- ``[OBB.cls](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.OBB.cls)

- ``[OBB.id](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.OBB.id)

- ``[OBB.xyxyxyxy](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.OBB.xyxyxyxy)

- ``[OBB.xyxyxyxyn](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.OBB.xyxyxyxyn)

- ``[OBB.xyxy](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.OBB.xyxy)

- ``[BaseTensor.cpu](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.BaseTensor.cpu)

- ``[BaseTensor.numpy](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.BaseTensor.numpy)

- ``[BaseTensor.cuda](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.BaseTensor.cuda)

- ``[BaseTensor.to](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.BaseTensor.to)

- ``[BaseTensor.__len__](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.BaseTensor.__len__)

- ``[BaseTensor.__getitem__](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.BaseTensor.__getitem__)

- ``[Results.__getitem__](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.Results.__getitem__)

- ``[Results.__len__](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.Results.__len__)

- ``[Results.update](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.Results.update)

- ``[Results._apply](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.Results._apply)

- ``[Results.cpu](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.Results.cpu)

- ``[Results.numpy](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.Results.numpy)

- ``[Results.cuda](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.Results.cuda)

- ``[Results.to](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.Results.to)

- ``[Results.new](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.Results.new)

- ``[Results.plot](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.Results.plot)

- ``[Results.show](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.Results.show)

- ``[Results.save](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.Results.save)

- ``[Results.verbose](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.Results.verbose)

- ``[Results.save_txt](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.Results.save_txt)

- ``[Results.save_crop](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.Results.save_crop)

- ``[Results.summary](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.Results.summary)
...
Name Type Description Default`data``torch.Tensor | np.ndarray`Prediction data such as bounding boxes, masks, or keypoints. required`orig_shape``tuple[int, int]`Original shape of the image in (height, width) format. required

Attributes

Name Type Description`data``torch.Tensor | np.ndarray`Prediction data such as bounding boxes, masks, or keypoints.`orig_shape``tuple[int, int]`Original shape of the image, typically in the format (height, width).

Methods

Name Description``[shape](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.BaseTensor.shape) Return the shape of the underlying data tensor.``[__getitem__](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.BaseTensor.__getitem__) Return a new BaseTensor instance containing the specified indexed elements of the data tensor.``[__len__](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.BaseTensor.__len__) Return the length of the underlying data tensor.``[cpu](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.BaseTensor.cpu) Return a copy of the tensor stored in CPU memory.``[cuda](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.BaseTensor.cuda) Move the tensor to GPU memory.``[numpy](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.BaseTensor.numpy) Return a copy of this object with its data converted to a NumPy array.``[to](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.BaseTensor.to) Return a copy of the tensor with the specified device and dtype.
...
Source code in `ultralytics/engine/results.py`[View on GitHub](https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L23-L173)
...
Type Description`tuple[int, ...]`The shape of the data tensor.
...
Source code in `ultralytics/engine/results.py`[View on GitHub](https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L62-L74)
...
Name Type Description Default`idx``int | list[int] | torch.Tensor`Index or indices to select from the data tensor. required

Returns

Type Description`BaseTensor`A new BaseTensor instance containing the indexed data.
...
Source code in `ultralytics/engine/results.py`[View on GitHub](https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L157-L173)
...
Type Description`int`The number of elements in the first dimension of the data tensor.
...
Source code in `ultralytics/engine/results.py`[View on GitHub](https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L143-L155)
...
Type Description`BaseTensor`A new BaseTensor object with the data tensor moved to CPU memory.
...
Source code in `ultralytics/engine/results.py`[View on GitHub](https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L76-L91)
...
Type Description`BaseTensor`A new BaseTensor instance with the data moved to GPU memory.
...
Source code in `ultralytics/engine/results.py`[View on GitHub](https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L109-L124)
...
Type Description`BaseTensor`A new instance with `data` as a NumPy array.
...
Source code in `ultralytics/engine/results.py`[View on GitHub](https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L93-L107)
...
Name Type Description Default`*args``Any`Variable length argument list to be passed to torch.Tensor.to(). required`**kwargs``Any`Arbitrary keyword arguments to be passed to torch.Tensor.to(). required

Returns

Type Description`BaseTensor`A new BaseTensor instance with the data moved to the specified device and/or dtype.
...
Source code in `ultralytics/engine/results.py`[View on GitHub](https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L126-L141)
...
Name Type Description Default`orig_img``np.ndarray`The original image as a numpy array. required`path``str`The path to the image file. required`names``dict`A dictionary of class names. required`boxes``torch.Tensor | None`A 2D tensor of bounding box coordinates for each detection.`None``masks``torch.Tensor | None`A 3D tensor of detection masks, where each mask is a binary image.`None``probs``torch.Tensor | None`A 1D tensor of probabilities of each class for classification task.`None``keypoints``torch.Tensor | None`A 2D tensor of keypoint coordinates for each detection.`None``obb``torch.Tensor | None`A 2D tensor of oriented bounding box coordinates for each detection.`None``speed``dict | None`A dictionary containing preprocess, inference, and postprocess speeds (ms/image).`None`

Attributes

Name Type Description`orig_img``np.ndarray`The original image as a numpy array.`orig_shape``tuple[int, int]`Original image shape in (height, width) format.`boxes``Boxes | None`Detected bounding boxes.`masks``Masks | None`Segmentation masks.`probs``Probs | None`Classification probabilities.`keypoints``Keypoints | None`Detected keypoints.`obb``OBB | None`Oriented bounding boxes.`speed``dict`Dictionary containing inference speed information.`names``dict`Dictionary mapping class indices to class names.`path``str`Path to the input image file.`save_dir``str | None`Directory to save results.

Methods

Name Description``[__getitem__](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.Results.__getitem__) Return a Results object for a specific index of inference results.``[__len__](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.Results.__len__) Return the number of detections in the Results object.``[_apply](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.Results._apply) Apply a function to all non-empty attributes and return a new Results object with modified attributes.``[cpu](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.Results.cpu) Return a copy of the Results object with all its tensors moved to CPU memory.``[cuda](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.Results.cuda) Move all tensors in the Results object to GPU memory.``[new](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.Results.new) Create a new Results object with the same image, path, names, and speed attributes.``[numpy](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.Results.numpy) Convert all tensors in the Results object to numpy arrays.``[plot](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.Results.plot) Plot detection results on an input BGR image.``[save](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.Results.save) Save annotated inference results image to file.``[save_crop](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.Results.save_crop) Save cropped detection images to specified directory.``[save_txt](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.Results.save_txt) Save detection results to a text file.``[show](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.Results.show) Display the image with annotated inference results.``[summary](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.Results.summary) Convert inference results to a summarized dictionary with optional normalization for box coordinates.``[to](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.Results.to) Move all tensors in the Results object to the specified device and dtype.``[update](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.Results.update) Update the Results object with new detection data.``[verbose](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.Results.verbose) Return a log string for each task in the results, detailing detection and classification outcomes.
...
Source code in `ultralytics/engine/results.py`[View on GitHub](https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L176-L822)
...
Name Type Description Default`idx``int | slice`Index or slice to retrieve from the Results object. required

Returns

Type Description`Results`A new Results object containing the specified subset of inference results.
...
Source code in `ultralytics/engine/results.py`[View on GitHub](https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L268-L282)
...
Type Description`int`The number of detections, determined by the length of the first non-empty attribute in (boxes, masks,
...
Source code in `ultralytics/engine/results.py`[View on GitHub](https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L284-L299)
...
Name Type Description Default`fn``str`The name of the function to apply. required`*args``Any`Variable length argument list to pass to the function. required`**kwargs``Any`Arbitrary keyword arguments to pass to the function. required

Returns

Type Description`Results`A new Results object with attributes modified by the applied function.
...
Source code in `ultralytics/engine/results.py`[View on GitHub](https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L338-L362)
...
Type Description`Results`A new Results object with all tensor attributes on CPU memory.
...
Source code in `ultralytics/engine/results.py`[View on GitHub](https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L364-L378)
...
Type Description`Results`A new Results object with all tensors moved to CUDA device.
...
Source code in `ultralytics/engine/results.py`[View on GitHub](https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L398-L410)
...
Type Description`Results`A new Results object with copied attributes from the original instance.
...
Source code in `ultralytics/engine/results.py`[View on GitHub](https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L430-L440)
...
Type Description`Results`A new Results object with all tensors converted to numpy arrays.
...
Source code in `ultralytics/engine/results.py`[View on GitHub](https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L380-L396)
...
Name Type Description Default`conf``bool`Whether to plot detection confidence scores.`True``line_width``float | None`Line width of bounding boxes. If None, scaled to image size.`None``font_size``float | None`Font size for text. If None, scaled to image size.`None``font``str`Font to use for text.`"Arial.ttf"``pil``bool`Whether to return the image as a PIL Image.`False``img``np.ndarray | None`Image to plot on. If None, uses original image.`None``im_gpu``torch.Tensor | None`Normalized image on GPU for faster mask plotting.`None``kpt_radius``int`Radius of drawn keypoints.`5``kpt_line``bool`Whether to draw lines connecting keypoints.`True``labels``bool`Whether to plot labels of bounding boxes.`True``boxes``bool`Whether to plot bounding boxes.`True``masks``bool`Whether to plot masks.`True``probs``bool`Whether to plot classification probabilities.`True``show``bool`Whether to display the annotated image.`False``save``bool`Whether to save the annotated image.`False``filename``str | None`Filename to save image if save is True.`None``color_mode``str`Specify the color mode, e.g., 'instance' or 'class'.`"class"``txt_color``tuple[int, int, int]`Text color in BGR format for classification output.`(255, 255, 255)`

Returns

Type Description`np.ndarray | PIL.Image.Image`Annotated image as a NumPy array (BGR) or PIL image (RGB) if `pil=True`.
...
Source code in `ultralytics/engine/results.py`[View on GitHub](https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L442-L579)
...
Name Type Description Default`filename``str | None`The filename to save the annotated image. If None, a default filename is generated
 based on the original image path.`None``*args``Any`Variable length argument list to be passed to the `plot` method. required`**kwargs``Any`Arbitrary keyword arguments to be passed to the `plot` method. required

Returns

Type Description`str`The filename where the image was saved.
...
Source code in `ultralytics/engine/results.py`[View on GitHub](https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L599-L628)
...
Name Type Description Default`save_dir``str | Path`Directory path where cropped images will be saved. required`file_name``str | Path`Base filename for the saved cropped images.`Path("im.jpg")`
...
Source code in `ultralytics/engine/results.py`[View on GitHub](https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L717-L750)
...
Name Type Description Default`txt_file``str | Path`Path to the output text file. required`save_conf``bool`Whether to include confidence scores in the output.`False`

Returns

Type Description`str`Path to the saved text file.
...
Source code in `ultralytics/engine/results.py`[View on GitHub](https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L661-L715)
...
Name Type Description Default`*args``Any`Variable length argument list to be passed to the `plot()` method. required`**kwargs``Any`Arbitrary keyword arguments to be passed to the `plot()` method. required
...
Source code in `ultralytics/engine/results.py`[View on GitHub](https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L581-L597)
...
Name Type Description Default`normalize``bool`Whether to normalize bounding box coordinates by image dimensions.`False``decimals``int`Number of decimal places to round the output values to.`5`

Returns

Type Description`list[dict[str, Any]]`A list of dictionaries, each containing summarized information for a single
...
Source code in `ultralytics/engine/results.py`[View on GitHub](https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L752-L822)
...
Type Description`Results`A new Results object with all tensors moved to the specified device and dtype.
...
Source code in `ultralytics/engine/results.py`[View on GitHub](https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L412-L428)
...
Name Type Description Default`boxes``torch.Tensor | None`A tensor of shape (N, 6) containing bounding box coordinates and confidence
 scores. The format is (x1, y1, x2, y2, conf, class).`None``masks``torch.Tensor | None`A tensor of shape (N, H, W) containing segmentation masks.`None``probs``torch.Tensor | None`A tensor of shape (num_classes,) containing class probabilities.`None``obb``torch.Tensor | None`A tensor of shape (N, 7) or (N, 8) containing oriented bounding box coordinates.`None``keypoints``torch.Tensor | None`A tensor of shape (N, K, 3) containing keypoints, were K=17 for persons.`None`
...
Source code in `ultralytics/engine/results.py`[View on GitHub](https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L301-L336)
...
Type Description`str`A formatted string containing a summary of the results. For detection tasks, it includes the number
...
Source code in `ultralytics/engine/results.py`[View on GitHub](https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L630-L659)
...
Name Type Description Default`boxes``torch.Tensor | np.ndarray`A tensor or numpy array with detection boxes of shape (num_boxes, 6) or
 (num_boxes, 7). Columns should contain [x1, y1, x2, y2, (optional) track_id, confidence, class]. required`orig_shape``tuple[int, int]`The original image shape as (height, width). Used for normalization. required

Attributes

Name Type Description`data``torch.Tensor | np.ndarray`The raw tensor containing detection boxes and associated data.`orig_shape``tuple[int, int]`The original image dimensions (height, width).`is_track``bool`Indicates whether tracking IDs are included in the box data.`xyxy``torch.Tensor | np.ndarray`Boxes in [x1, y1, x2, y2] format.`conf``torch.Tensor | np.ndarray`Confidence scores for each box.`cls``torch.Tensor | np.ndarray`Class labels for each box.`id``torch.Tensor | None`Tracking IDs for each box (if available).`xywh``torch.Tensor | np.ndarray`Boxes in [x, y, width, height] format.`xyxyn``torch.Tensor | np.ndarray`Normalized [x1, y1, x2, y2] boxes relative to orig_shape.`xywhn``torch.Tensor | np.ndarray`Normalized [x, y, width, height] boxes relative to orig_shape.

Methods

Name Description``[xyxy](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.Boxes.xyxy) Return bounding boxes in [x1, y1, x2, y2] format.``[conf](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.Boxes.conf) Return the confidence scores for each detection box.``[cls](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.Boxes.cls) Return the class ID tensor representing category predictions for each bounding box.``[id](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.Boxes.id) Return the tracking IDs for each detection box if available.``[xywh](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.Boxes.xywh) Convert bounding boxes from [x1, y1, x2, y2] format to [x, y, width, height] format.``[xyxyn](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.Boxes.xyxyn) Return normalized bounding box coordinates relative to the original image size.``[xywhn](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.Boxes.xywhn) Return normalized bounding boxes in [x, y, width, height] format.
...
Type Description`torch.Tensor | np.ndarray`A tensor or numpy array of shape (n, 4) containing bounding box coordinates in
...
Source code in `ultralytics/engine/results.py`[View on GitHub](https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L882-L895)
...
Type Description`torch.Tensor | np.ndarray`A 1D tensor or array containing confidence scores for each detection, with
...
Source code in `ultralytics/engine/results.py`[View on GitHub](https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L898-L911)
...
Type Description`torch.Tensor | np.ndarray`A tensor or numpy array containing the class IDs for each detection box. The
...
Source code in `ultralytics/engine/results.py`[View on GitHub](https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L914-L927)
...
Type Description`torch.Tensor | np.ndarray | None`A tensor or array containing tracking IDs for each box if tracking is
...
Source code in `ultralytics/engine/results.py`[View on GitHub](https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L930-L951)
...
Type Description`torch.Tensor | np.ndarray`Boxes in [x_center, y_center, width, height] format, where x_center, y_center
...
Source code in `ultralytics/engine/results.py`[View on GitHub](https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L955-L972)
...
Type Description`torch.Tensor | np.ndarray`Normalized bounding box coordinates with shape (N, 4), where N is the number of
...
Source code in `ultralytics/engine/results.py`[View on GitHub](https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L976-L995)
...
Type Description`torch.Tensor | np.ndarray`Normalized bounding boxes with shape (N, 4), where N is the number of boxes.
...
Source code in `ultralytics/engine/results.py`[View on GitHub](https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L999-L1019)
...
Name Type Description Default`masks``torch.Tensor | np.ndarray`Detection masks with shape (num_masks, height, width). required`orig_shape``tuple[int, int]`The original image shape as (height, width). Used for normalization. required

Attributes

Name Type Description`data``torch.Tensor | np.ndarray`The raw tensor or array containing mask data.`orig_shape``tuple[int, int]`Original image shape in (height, width) format.`xy``list[np.ndarray]`A list of segments in pixel coordinates.`xyn``list[np.ndarray]`A list of normalized segments.

Methods

Name Description``[xyn](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.Masks.xyn) Return normalized xy-coordinates of the segmentation masks.``[xy](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.Masks.xy) Return the [x, y] pixel coordinates for each segment in the mask tensor.
...
Source code in `ultralytics/engine/results.py`[View on GitHub](https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L1022-L1105)
...
Type Description`list[np.ndarray]`A list of numpy arrays, where each array contains the normalized xy-coordinates of a
...
Source code in `ultralytics/engine/results.py`[View on GitHub](https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L1061-L1081)
...
Type Description`list[np.ndarray]`A list of numpy arrays, where each array contains the [x, y] pixel coordinates for a
...
Source code in `ultralytics/engine/results.py`[View on GitHub](https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L1085-L1105)
...
Name Type Description Default`keypoints``torch.Tensor | np.ndarray`A tensor or array containing keypoint data. Shape can be either:
 - (num_objects, num_keypoints, 2) for x, y coordinates only
 - (num_objects, num_keypoints, 3) for x, y coordinates and confidence scores required`orig_shape``tuple[int, int]`The original image dimensions (height, width). required

Attributes

Name Type Description`data``torch.Tensor`The raw tensor containing keypoint data.`orig_shape``tuple[int, int]`The original image dimensions (height, width).`has_visible``bool`Indicates whether visibility information is available for keypoints.`xy``torch.Tensor`Keypoint coordinates in [x, y] format.`xyn``torch.Tensor`Normalized keypoint coordinates in [x, y] format, relative to orig_shape.`conf``torch.Tensor | None`Confidence values for each keypoint, if available.

Methods

Name Description``[xy](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.Keypoints.xy) Return x, y coordinates of keypoints.``[xyn](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.Keypoints.xyn) Return normalized coordinates (x, y) of keypoints relative to the original image size.``[conf](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.Keypoints.conf) Return confidence values for each keypoint.
...
Source code in `ultralytics/engine/results.py`[View on GitHub](https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L1108-L1213)
...
Type Description`torch.Tensor | np.ndarray`A tensor or array containing the x, y coordinates of keypoints with shape (N,
...
Source code in `ultralytics/engine/results.py`[View on GitHub](https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L1157-L1175)
...
Type Description`torch.Tensor | np.ndarray`A tensor or array of shape (N, K, 2) containing normalized keypoint
...
Source code in `ultralytics/engine/results.py`[View on GitHub](https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L1179-L1196)
...
Type Description`torch.Tensor | np.ndarray | None`A tensor or array containing confidence scores for each keypoint if
...
Source code in `ultralytics/engine/results.py`[View on GitHub](https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L1200-L1213)
...
Name Type Description Default`probs``torch.Tensor | np.ndarray`A 1D tensor or array of classification probabilities. required`orig_shape``tuple[int, int] | None`The original image shape as (height, width). Not used in this class but
 kept for consistency with other result classes.`None`

Attributes

Name Type Description`data``torch.Tensor | np.ndarray`The raw tensor or array containing classification probabilities.`orig_shape``tuple[int, int] | None`The original image shape as (height, width). Not used in this class.`top1``int`Index of the class with the highest probability.`top5``list[int]`Indices of the top 5 classes by probability.`top1conf``torch.Tensor | np.ndarray`Confidence score of the top 1 class.`top5conf``torch.Tensor | np.ndarray`Confidence scores of the top 5 classes.

Methods

Name Description``[top1](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.Probs.top1) Return the index of the class with the highest probability.``[top5](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.Probs.top5) Return the indices of the top 5 class probabilities.``[top1conf](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.Probs.top1conf) Return the confidence score of the highest probability class.``[top5conf](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.Probs.top5conf) Return confidence scores for the top 5 classification predictions.
...
Source code in `ultralytics/engine/results.py`[View on GitHub](https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L1216-L1330)
...
Type Description`int`Index of the class with the highest probability.
...
Source code in `ultralytics/engine/results.py`[View on GitHub](https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L1264-L1275)
...
Type Description`list[int]`A list containing the indices of the top 5 class probabilities, sorted in descending order.
...
Source code in `ultralytics/engine/results.py`[View on GitHub](https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L1279-L1290)
...
Type Description`torch.Tensor | np.ndarray`A tensor containing the confidence score of the top 1 class.
...
Source code in `ultralytics/engine/results.py`[View on GitHub](https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L1294-L1309)
...
Type Description`torch.Tensor | np.ndarray`A tensor or array containing the confidence scores for the top 5 predicted
...
Source code in `ultralytics/engine/results.py`[View on GitHub](https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L1313-L1330)
...
Name Type Description Default`boxes``torch.Tensor | np.ndarray`A tensor or numpy array containing the detection boxes, with shape
 (num_boxes, 7) or (num_boxes, 8). The last two columns contain confidence and class values. If present,
 the third last column contains track IDs, and the fifth column contains rotation. required`orig_shape``tuple[int, int]`Original image size, in the format (height, width). required

Attributes

Name Type Description`data``torch.Tensor`The raw OBB tensor containing box coordinates and associated data.`orig_shape``tuple[int, int]`Original image size as (height, width).`is_track``bool`Indicates whether tracking IDs are included in the box data.`xywhr``torch.Tensor | np.ndarray`Boxes in [x_center, y_center, width, height, rotation] format.`conf``torch.Tensor | np.ndarray`Confidence scores for each box.`cls``torch.Tensor | np.ndarray`Class labels for each box.`id``torch.Tensor | np.ndarray`Tracking IDs for each box, if available.`xyxyxyxy``torch.Tensor | np.ndarray`Boxes in 8-point [x1, y1, x2, y2, x3, y3, x4, y4] format.`xyxyxyxyn``torch.Tensor | np.ndarray`Normalized 8-point coordinates relative to orig_shape.`xyxy``torch.Tensor | np.ndarray`Axis-aligned bounding boxes in [x1, y1, x2, y2] format.

Methods

Name Description``[xywhr](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.OBB.xywhr) Return boxes in [x_center, y_center, width, height, rotation] format.``[conf](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.OBB.conf) Return the confidence scores for Oriented Bounding Boxes (OBBs).``[cls](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.OBB.cls) Return the class values of the oriented bounding boxes.``[id](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.OBB.id) Return the tracking IDs of the oriented bounding boxes (if available).``[xyxyxyxy](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.OBB.xyxyxyxy) Convert OBB format to 8-point (xyxyxyxy) coordinate format for rotated bounding boxes.``[xyxyxyxyn](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.OBB.xyxyxyxyn) Convert rotated bounding boxes to normalized xyxyxyxy format.``[xyxy](https://docs.ultralytics.com/reference/engine/results/#ultralytics.engine.results.OBB.xyxy) Convert oriented bounding boxes (OBB) to axis-aligned bounding boxes in xyxy format.
...
Type Description`AssertionError`If the number of values per box is not 7 or 8. Source code in `ultralytics/engine/results.py`[View on GitHub](https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L1333-L1533)
...
Type Description`torch.Tensor | np.ndarray`A tensor or numpy array containing the oriented bounding boxes with format
...
Source code in `ultralytics/engine/results.py`[View on GitHub](https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L1389-L1403)
...
Type Description`torch.Tensor | np.ndarray`A tensor or numpy array of shape (N,) containing confidence scores for N
...
Source code in `ultralytics/engine/results.py`[View on GitHub](https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L1406-L1422)
...
Type Description`torch.Tensor | np.ndarray`A tensor or numpy array containing the class values for each oriented bounding
...
Source code in `ultralytics/engine/results.py`[View on GitHub](https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L1425-L1439)
...
Type Description`torch.Tensor | np.ndarray | None`A tensor or numpy array containing the tracking IDs for each oriented
...
Source code in `ultralytics/engine/results.py`[View on GitHub](https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L1442-L1457)
...
Type Description`torch.Tensor | np.ndarray`Rotated bounding boxes in xyxyxyxy format with shape (N, 4, 2), where N is the
...
Source code in `ultralytics/engine/results.py`[View on GitHub](https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L1461-L1475)
...
Type Description`torch.Tensor | np.ndarray`Normalized rotated bounding boxes in xyxyxyxy format with shape (N, 4, 2),
...
Source code in `ultralytics/engine/results.py`[View on GitHub](https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L1479-L1496)
...
Type Description`torch.Tensor | np.ndarray`Axis-aligned bounding boxes in xyxy format with shape (N, 4), where N is the
...
Source code in `ultralytics/engine/results.py`[View on GitHub](https://github.com/ultralytics/ultralytics/blob/main/ultralytics/engine/results.py#L1500-L1533)
...
📅  Created 2 years ago ✏️  Updated 4 months ago 

[https://github.com/glenn-jocher](https://github.com/glenn-jocher)[https://github.com/jk4e](https://github.com/jk4e)[https://github.com/Burhan-Q](https://github.com/Burhan-Q)
